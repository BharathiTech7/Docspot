...
const docController = async (req, res) => {
  try {
    ...
    console.error("Error in docController:", error.message || error);
    res.status(500).send({
...
const appointmentController = async (req, res) => {
  try {
    ...
    console.log("Uploaded File:", req.file); // Log the file (if any)
    ...
    const newAppointment = new appointmentSchema({
      userId: userId, // Correctly setting the userId
    ...
    // Notify the doctor (user linked to the doctor)
...
const getAllUserAppointments = async (req, res) => {
  try {
    ...
    // Ensure userId is converted properly
    ...
    console.log("Appointments with Doctor Info:", appointmentsWithDoctor);
